...
import { getCourse } from '../../services/courses.js';
import { getAssignmentDetails } from '../../services/assignments.js';
import { updateStudentDetails } from '../../services/students.js';
...
export default function SingleAssignmentGrid() {
  ...
  const handleCheckboxChange = async (studentId, field) => {
    ...
    try {
      await updateStudentDetails(courseId, studentId, payload);
    } catch (error) {
